...
export default function createMatrix() {
    ...
    const verticalLegend = d3.svg.legend().labelFormat('none').cellPadding(5).orientation('vertical').units('Region by Color').cellWidth(25).cellHeight(18).inputScale(c,sampleCategoricalData).cellStepping(10);
